...
const ExploreAppPage = ({ navigation }) => {
  ...
  return (
    ...
    <View style={styles.root}>
      ...
      <Text style={styles.heading1}>Explore Your App</Text>
      <Text style={styles.heading2}>For more details please contact a staff member of "Gym C"</Text>
      <Text style={styles.heading1}>Gear up Yourself</Text>
      ...
      <View style={styles.loginButton}>
        <CustomButton text="Finish" type="PRIMARY" bgColor="#3DA2FF" fgColor="white"
          onPress={() =>
            navigation.navigate('TraineeHome', { name: 'Jane' })}
        />
      </View>
